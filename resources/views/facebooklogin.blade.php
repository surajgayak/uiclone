<x-navbar></x-navbar>
<div class="container mx-auto p-4  sm:w-full md:w-1/2 m-auto shadow-md rounded">
    <form action="{{ url('/fblogin') }}" method="post">
        @csrf
        <div class="mb-4 ">
        ...
        <div class="mb-4">
            ...
            <select id="category" class="w-full px-3 py-2 border rounded" name="categoryselect">
        ...
        <div class="mb-4">
            ...
            <select id="product" class="w-full px-3 py-2 border rounded" name="productselect">
                <option value="" selected disabled>----Slect main category----</option>
        ...
        <input type="submit" class="px-4 py-2 bg-blue-500 text-white rounded" value="Add to Cart">
    </form>
</div>
