...
<body>
    <nav aria-label="navbar" x-data class="border-b bg-white shadow-lg">
        <div class="mx-auto max-w-screen-xl px-1 py-4">
            <div class="flex items-center justify-between">
                <a class="cursor-pointer " href="{{ route('welcome') }}">
                    <img src="/images/logo.png" class="w-36 h-12" alt="website logo" />
                </a>
                <ul class="flex items-center gap-x-8">
                    ...
                    <li class="hidden sm:block">
                        <a href="{{ route('contact') }}"
                            class="cursor-pointer text-sm font-medium text-gray-900 hover:text-gray-900/70 focus:text-gray-900/70">Contact</a>
                    </li>
            ...
            <div class="absolute right-0 top-0 z-50 h-full w-[200px] border-l bg-white shadow-lg">
                ...
                <div class="border-b p-4">
                    <ul class="flex flex-col gap-y-3">
                        <li>
                            <a href="{{ route('welcome') }}"
                                class="cursor-pointer text-sm font-medium text-gray-900 hover:text-gray-900/70">Home</a>
                        </li>
                        <li>
                            <a href="{{ route('contact') }}"
                                class="cursor-pointer text-sm font-medium text-gray-900 hover:text-gray-900/70">Contact</a>
                        </li>
